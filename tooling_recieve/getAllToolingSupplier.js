...
export const options = {
  ...
  thresholds: {
    http_req_duration: ["p(90)<500"], // จำกัด Response Time ให้อยู่ใน 500ms
    "http_req_duration{status:200}": ["p(90)<400"],
    http_reqs: ["count<5000"], // จำกัดจำนวน Requests รวม
  },
};
...
export default function () {
  ...
  sleep(getRandomDelay(5, 10)); // หยุดพักระหว่าง 5 - 10 วินาที
}
